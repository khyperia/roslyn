...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class LocalRewriter
    {
        ...
        private BoundExpression MakeCollectionInitializer(BoundExpression rewrittenReceiver, BoundCollectionElementInitializer initializer)
        {
            ...
            rewrittenArguments = MakeArguments(syntax, rewrittenArguments, addMethod, addMethod, initializer.Expanded, initializer.InvokedAsExtensionMethod, initializer.ArgsToParamsOpt, ref rewrittenReceiver, ref argumentRefKindsOpt, out temps, enableCallerInfo: ThreeState.True);
